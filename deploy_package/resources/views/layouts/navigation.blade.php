<nav x-data="{ open: false }" class="bg-white border-b border-slate-200 shadow-sm z-10 sticky top-0">
    <!-- Primary Navigation Menu -->
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Hamburger (Mobile) -->
                <div class="-me-2 flex items-center md:hidden pr-4">
            ...
            <!-- Empty Div to keep settings on right if needed -->
            <div class="-me-2 flex items-center sm:hidden">
                <!-- Hamburger is on the left now -->
            </div>
        </div>
    </div>
