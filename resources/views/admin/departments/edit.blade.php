                ...
                <form method="POST" action="{{ route('admin.departments.update', $department) }}">
                    ...
                    <div class="block mt-4">
                        <label for="is_active" class="inline-flex items-center cursor-pointer">
                            ...
                            <input id="is_active" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="is_active" value="1" {{ old('is_active', $department->is_active) ? 'checked' : '' }}>
